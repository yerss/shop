<template>
    <div class="page-main-header">
        <div class="main-header-left">
            <div class="logo-wrapper"><router-link to="/"><img class="blur-up lazyloaded" src="../../../assets/images/layout-2/logo/logo.png" alt=""></router-link></div>
        </div>
                    ...
                    <li>
                        <form class="form-inline search-form">
                            <div class="form-group">
                                <input class="form-control-plaintext" type="search" placeholder="Поиск.."><span class="d-sm-none mobile-search"><i data-feather="search"></i></span>
                            </div>
                        </form>
                    </li>

                    <li><a class="text-dark" href="#!" @click="toggleFullScreen"><i data-feather="maximize"></i></a></li>
